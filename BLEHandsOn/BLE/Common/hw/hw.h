...
#include "stm32l4xx_hal_rtc.h" // for rtc structures
 ...
 */
typedef enum {
    hw_ts_InitMode_Full, hw_ts_InitMode_Limited,
} HW_TS_InitMode_t;
 ...
 */
typedef enum {
    hw_ts_SingleShot, hw_ts_Repeated
} HW_TS_Mode_t;
